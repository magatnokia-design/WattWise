...
// Deliberately duplicated in src/utils/billing.js - keep both in sync.
//
...
const RATE_EFFECTIVE_DATE = '2026-06';
...
const EVAT_SUPPLY_FACTOR = 0.1187;
...
const DEFAULT_GEN_RATE_ADJ = -0.0306;
...
const SUPPLY_RATE_FIELDS = SUPPLY_LINES.map(([key, label]) => ({
  key,
  label,
